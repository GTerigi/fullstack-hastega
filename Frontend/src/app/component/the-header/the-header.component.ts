...
export class TheHeaderComponent implements OnInit {
  ...
  useNavbarMenu!: boolean;

  constructor(private userService: UserService, private router: Router, private deviceService: DeviceDetectorService) {
    ...
    this.useNavbarMenu = this.deviceService.isMobile() || this.deviceService.isTablet() || this.deviceService.getDeviceInfo().orientation === "portrait";
  }
